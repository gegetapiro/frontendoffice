...
<body>
    <div class="container">
        ...
        if (!$link) {
            ...
            $query = "SELECT * FROM $table WHERE id = " . $_GET["cheid"];
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                        $("#sendbut").click(function() {
                            ...
                            window.open("updateExitTime.php?whattaid=" + whattaID + "&whattaextime=" + whatexittime + "&whattanote=" + whatnote + "&whattaexidata=" + whatexitData, "_self");
                        ...
                        <tr>
                            ...
                            <td>
                                <p>
                                    ...
                                    <input type="text" id="datepicker2" size="8" value="<?php echo $datitab[1] ?>" disabled="disabled">
                                </p>
                            </td>

                            <td>
                                <input type="text" name="oraingresso" disabled="disabled" value="<?php echo $datitab[2] ?>">
                            </td>
                            <td>
                                <input type="text" name="nominativo" id="nominativo" disabled="disabled" value="<?php echo $datitab[3] ?>" />
                            </td>
                            <td>

                                <input type="text" name="tipoDocumento" id="tipoDocumento" disabled="disabled" value="<?php echo $datitab[4] ?>" />

                            </td>
                            <td>
                                <input type="text" name="documento" id="documento" disabled="disabled" value="<?php echo $datitab[5] ?>" />
                            </td>
                            <td>
                                <input type="text" name="numBadge" id="numBadge" disabled="disabled" value="<?php echo $datitab[6] ?>" size="1" />
                            </td>
                            <td>
                                <input type="text" name="societa" id="societa" disabled="disabled" value="<?php echo $datitab[7] ?>" />
                            </td>
                            <td>
                                <input type="text" name="referente" id="referente" disabled="disabled" value="<?php echo $datitab[8] ?>" />
                            </td>
                            <td>
                                <select id="orauscita">
                            ...
                            <td>
                                <input type="text" name="exitdata" id="exitdata" disabled="disabled" value="" />
                            </td>
                            <td>
